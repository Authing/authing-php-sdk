...
class AuthenticationClient
{
     ...
     * 构造协议相关请求
     */
    private function sendProtocolRequest($parPath, $parGet = [], $parPost = [], $parHeader = [])
    {
        //处理
        ...
        //请求
        $res = Util\Tool::request($this->_appHost . $parPath, $parGet, $parPost, $varHeader, $this->_option["timeout"]);
        return $res["body"];
    }
    ...
    private function _requests($parMethod, $parGet = [], $parPost = [], $parHeader = [])
    {
        ...
        $varHeader = array_merge($varHeader, $parHeader);
        //请求
        $varReq = Util\Tool::request($this->_appHost . $parMethod, $parGet, $parPost, $varHeader, $this->_option["timeout"]);
        //错误
        if ($varReq["error"]) {
    ...
    private function _buildLoginState($tokenRes)
    {
        return array(
            ...
            "refreshToken" => Util\Tool::getOrDefault($tokenRes["refresh_token"]),
    ...
    private function _getAccessTokenByCodeWithClientSecretPost($code, $codeVerifier = null)
    {
        ...
        return $this->sendProtocolRequest($api, null, $data, []);
    }
    ...
    public function getUserInfoByAccessToken($accessToken)
    {
        ...
        return $this->sendProtocolRequest($api, null, null, [
    ...
    public function _introspectTokenWithClientSecretPost($token)
    {
        ...
        return $this->sendProtocolRequest($api, null, $qstr, []);
    }
    ...
    public function revokeToken($token)
    {
        ...
        if (!isset($this->options->secret) && $this->_option["revocationEndPointAuthMethod"] !== 'none') {
            throw new \Exception(
                '请在初始化 AuthenticationClient 时传入 appId 和 secret 参数'
            );
        }
    ...
    public function signInByEmailPassword($email, $password, $option = null)
    {
        ...
        // 发送请求
        $varRes = $this->_requests("/api/v3/signin", null, $varPost);
        // 返回
        return $varRes["body"];
    }
     ...
     */
    public function signUpByUsernamePassword($username, $password, $option = null)
    {
        // 组装请求
        $varPost = array(
            "connection" => "PASSWORD",
        ...
        // 发送请求
        $varRes = $this->_requests("/api/v3/signup", null, $varPost);
        // 返回
        return $varRes["body"];
    }
     ...
     * @param object $option 注册可选参数，详情请见文档
     */
    public function signUpByEmailPassword($email, $password, $option = null)
    {
        // 组装请求
        $varPost = array(
            "connection" => "PASSWORD",
     ...
     * @param object $option 注册可选参数，详情请见文档
     */
    public function signUpByPhonePassCode($phone, $passCode, $phoneCountryCode = null, $option = null)
    {
        // 组装请求
        $varPost = array(
            "connection" => "PASSCODE",
     ...
     * @param object $option 注册可选参数，详情请见文档
     */
    public function signUpByEmailPassCode($email, $passCode, $option = null)
    {
        // 组装请求
        $varPost = array(
            "connection" => "PASSCODE",
 ...
 * @param 'OTP' | 'SMS' | 'EMAIL' | 'FACE' factorType 必须，MFA 认证要素类型，目前共支持短信、邮箱验证码、OTP、人脸四种类型的认证要素。
...
public function sendEnrollFactorRequest($option = array())
{
    ...
    // 发送请求
    $varRes = $this->_requests("/api/v3/send-enroll-factor-request", null, $varPost);
    // 返回
    return $varRes["body"];
}
...
public function enrollFactor($option = array())
{
    ...
    // 发送请求
    $varRes = $this->_requests("/api/v3/enroll-factor", null, $varPost);
    // 返回
    return $varRes["body"];
}
...
public function resetFactor($option = array())
{
    ...
    // 发送请求
    $varRes = $this->_requests("/api/v3/reset-factor", null, $varPost);
    // 返回
    return $varRes["body"];
}
...
{
    // 发送请求
    $varRes = $this->_requests("/api/v3/list-enrolled-factors", null, null);
    // 返回
    return $varRes["body"];
}
...
public function getFactor($option = array())
{
    ...
    // 发送请求
    $varRes = $this->_requests("/api/v3/get-factor", $varGet, null);
    // 返回
    return $varRes["body"];
}
...
{
    // 发送请求
    $varRes = $this->_requests("/api/v3/list-factors-to-enroll", null, null);
    // 返回
    return $varRes["body"];
}
             ...
             * {
                 ...
                 * {
                     ...
                     * {
                         ...
                         */
                        public function linkExtIdp($option = array())
                        {
                            // 组装请求
                            $varGet = array(
                            ...
                            // 发送请求
                            $varRes = $this->_requests("/api/v3/link-extidp", $varGet, null);
                            // 返回
                            return $varRes["body"];
                        }
                                         ...
                                         * {
                                             ...
                                             * {
                                                ...
                                                public function generateLinkExtIdpUrl($option = array())
                                                {
                                                    ...
                                                    // 发送请求
                                                    $varRes = $this->_requests("/api/v3/generate-link-extidp-url", $varGet, null);
                                                    // 返回
                                                    return $varRes["body"];
                                                }
                                                 ...
                                                 */
                                                public function unbindExtIdp($option = array())
                                                {
                                                    // 组装请求
                                                    $varPost = array(
                                                    ...
                                                    // 发送请求
                                                    $varRes = $this->_requests("/api/v3/unlink-extidp", null, $varPost);
                                                    // 返回
                                                    return $varRes["body"];
                                                }
                                                 ...
                                                 * [
                                                     * {
                                                         ...
                                                         * {
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-identities", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                             ...
                                                             */
                                                            public function getExtIdps($option = array())
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-extidps", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                             ...
                                                             *
                                                             * @param SignUpByPasswordDto passwordPayload 可选，当主持方式为 `PASSWORD` 时此参数必填。，默认 null
                                                            ...
                                                            public function decryptWechatMiniProgramData($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/decrypt-wechat-miniprogram-data", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function getWechatMiniprogramPhone($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-wechat-miniprogram-phone", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function getWechatMpAccessToken($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-wechat-access-token", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function getLoginHistory($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-login-history", $varGet, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-logged-in-apps", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-accessible-apps", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function getDepartmentList($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-department-list", $varGet, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                             ...
                                                             * @summary 文件上传
                                                             * @param array $option 用于传递参数，如 array("email" => "main@test.com")
                                                             * @param string folder 可选，上传的目录，默认 null
                                                             * @param boolean isPrivate 可选，是否为私有资源，默认 null
                                                            ...
                                                            public function upload($option = array())
                                                            {
                                                                // 组装请求
                                                                $varPost = array(
                                                                    "folder" => Util\Tool::getOrDefault($option, "folder", null),
                                                                    "isPrivate" => Util\Tool::getOrDefault($option, "isPrivate", null),
                                                                );
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v2/upload", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                             ...
                                                             * @param 'wechat' | 'alipay' | 'wechatwork' | 'wechatwork_agency' | 'lark_internal' | 'lark_public' | 'yidun' | 'wechat_mini_program_code' | 'wechat_mini_program_phone' | 'google' connection 必须，移动端社会化登录类型：
                                                             * - `wechat`: 微信移动应用
                                                             * - `alipay`: 支付宝移动应用
                                                             * - `wechatwork`: 企业微信移动应用
                                                             ...
                                                             *
                                                             * @param SignInByWechatPayloadDto wechatPayload 可选，微信移动端社会化登录数据，当 `connection` 为 `wechat` 的时候必填，默认 null
                                                             * @param SignInByAlipayPayloadDto alipayPayload 可选，支付宝移动端社会化登录数据，当 `connection` 为 `alipay` 的时候必填，默认 null
                                                             * @param AuthenticateByWechatworkDto wechatworkPayload 可选，企业微信移动端社会化登录数据，当 `connection` 为 `wechatwork` 的时候必填，默认 null
                                                            ...
                                                            public function signInByMobile($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/signin-by-mobile", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function getAlipayAuthInfo($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-alipay-authinfo", $varGet, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function geneQrCode($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/gene-qrcode", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function checkQrCodeStatus($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/check-qrcode-status", $varGet, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function exchangeTokenSetWithQrCodeTicket($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/exchange-tokenset-with-qrcode-ticket", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function changeQrCodeStatus($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/change-qrcode-status", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function sendSms($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/send-sms", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                             ...
                                                             * @param array $option 用于传递参数，如 array("email" => "main@test.com")
                                                             * @param 'CHANNEL_LOGIN' | 'CHANNEL_REGISTER' | 'CHANNEL_RESET_PASSWORD' | 'CHANNEL_VERIFY_EMAIL_LINK' | 'CHANNEL_UPDATE_EMAIL' | 'CHANNEL_BIND_EMAIL' | 'CHANNEL_UNBIND_EMAIL' | 'CHANNEL_VERIFY_MFA' | 'CHANNEL_UNLOCK_ACCOUNT' | 'CHANNEL_COMPLETE_EMAIL' channel 必须，短信通道，指定发送此短信的目的：
                                                             * - `CHANNEL_LOGIN`: 用户用户登录
                                                             * - `CHANNEL_REGISTER`: 用于用户注册
                                                             * - `CHANNEL_RESET_PASSWORD`: 用于重置密码
                                                            ...
                                                            public function sendEmail($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/send-email", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function getProfile($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-profile", $varGet, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function updateProfile($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/update-profile", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function bindEmail($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/bind-email", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/unbind-email", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function bindPhone($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/bind-phone", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/unbind-phone", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-security-info", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                             ...
                                                             * @param 'sm2' | 'rsa' | 'none' passwordEncryptType 可选，密码加密类型，支持 sm2 和 rsa。默认可以不加密。
                                                            ...
                                                            public function updatePassword($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/update-password", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function verifyUpdateEmailRequest($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/verify-update-email-request", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function updateEmail($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/update-email", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function verifyUpdatePhoneRequest($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/verify-update-phone-request", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function updatePhone($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/update-phone", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function verifyResetPasswordRequest($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/verify-reset-password-request", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function resetPassword($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/reset-password", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                             ...
                                                             */
                                                            public function veirfyDeleteAccountRequest($option = array())
                                                            {
                                                                // 组装请求
                                                                $varPost = array(
                                                                    "verifyMethod" => Util\Tool::getOrDefault($option, "verifyMethod", null),
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/verify-delete-account-request", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function deleteAccount($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/delete-account", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/system", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            {
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/get-country-list", null, null);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
                                                            ...
                                                            public function preCheckCode($option = array())
                                                            {
                                                                ...
                                                                // 发送请求
                                                                $varRes = $this->_requests("/api/v3/pre-check-code", null, $varPost);
                                                                // 返回
                                                                return $varRes["body"];
                                                            }
