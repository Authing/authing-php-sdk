...
// $res = $aclManageClient->createProgrammaticAccessAccount('5f97fb40d352ecf69ffe6d98');
// 禁用编程访问账号 disableProgrammaticAccessAccount
// $res = $aclManageClient->disableProgrammaticAccessAccount("6073b2dfbf75746b6662ee6f");
// 删除编程访问账号 deleteProgrammaticAccessAccount
// $res = $aclManageClient->deleteProgrammaticAccessAccount("6073b2dfbf75746b6662ee6f");

// 启用编程访问账号 enableProgrammaticAccessAccount
// $res = $aclManageClient->enableProgrammaticAccessAccount("6073b2dfbf75746b6662ee6f");

// 刷新编程访问账号密钥 refreshProgrammaticAccessAccountSecret
// 60715954810047a584d5a612    5570623490fc9a23cdf47b4dffe2b752
$res = $aclManageClient->refreshProgrammaticAccessAccountSecret("6073b2dfbf75746b6662ee6f");
...
// $arr = [
//     'a' => '调用封装的接口，需要转为 json格式，使用json_encode()，但是传递的中文被编码了，'
// ];
$a = json_encode($res);
echo $a;
echo 'ok';